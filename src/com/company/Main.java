...
//                        int doubleHeight = 0;
//                        int font = 3;
//                        int modeCachingStr = 2;
//                        String text = "123456789_123456789_123456789_123456789_123456789_";
//
//                        fptr.directIO(1001, new int[]{alignment, doubleWidth, doubleHeight, 0, font, modeCachingStr}, text);
                        ...
                        fptr.directIO(1063, null, null);
                        //byte[] markingCode = {0x30,0x3B,0x30,0x31,0x30,0x33,0x30,0x34,0x31,0x30,0x39,0x34,0x37,0x38,0x37,0x34,0x34,0x33,0x32,0x31,0x35,0x51,0x62,0x61,0x67,0x21,0x3C,0x30,0x78,0x31,0x44,0x3E,0x39,0x33,0x5A,0x6A,0x71,0x77,0x3C,0x30,0x78,0x31,0x44,0x3E,0x33,0x31,0x30,0x33,0x30,0x30,0x30,0x33,0x35,0x33,0x3B,(byte) 0xD3,0x07,0x01,0x00,0x01,0x36,0x08,0x01,0x00,0x00,0x3B};
                        byte[] markingCode = {0x30,0x3B,0x30,0x31,0x30,0x34,0x36,0x30,0x37,0x30,0x30,0x37,0x33,0x36,0x30,0x30,0x35,0x30,0x32,0x31,0x64,0x36,0x41,0x47,0x62,0x70,0x41,0x62,0x64,0x67,0x45,0x6C,0x4A,0x3C,0x30,0x78,0x31,0x44,0x3E,0x39,0x31,0x45,0x45,0x30,0x36,0x3C,0x30,0x78,0x31,0x44,0x3E,0x39,0x32,0x2B,0x52,0x30,0x36,0x4D,0x77,0x57,0x50,0x6E,0x30,0x4B,0x70,0x52,0x63,0x6A,0x67,0x72,0x34,0x7A,0x37,0x66,0x63,0x2B,0x51,0x47,0x69,0x64,0x47,0x79,0x50,0x79,0x51,0x58,0x7A,0x62,0x79,0x4A,0x50,0x70,0x74,0x4E,0x59,0x41,0x3D,0x3B,(byte) 0xD3,0x07,0x01,0x00,0x01,0x36,0x08,0x01,0x00,0x00,0x3B};
                        //tabacco byte [] markingCode = {0x30,0x3B,0x30,0x31,0x30,0x34,0x36,0x30,0x30,0x32,0x36,0x36,0x30,0x31,0x31,0x35,0x33,0x34,0x32,0x31,0x79,0x6E,0x64,0x52,0x43,0x21,0x3F,0x3C,0x30,0x78,0x31,0x44,0x3E,0x38,0x30,0x30,0x35,0x31,0x34,0x31,0x30,0x30,0x30,0x3C,0x30,0x78,0x31,0x44,0x3E,0x39,0x33,0x39,0x78,0x7A,0x54,0x3C,0x30,0x78,0x31,0x44,0x3E,0x32,0x34,0x30,0x31,0x30,0x30,0x37,0x33,0x33,0x35,0x33,0x3C,0x30,0x78,0x31,0x44,0x3E,0x3B,(byte) 0xD3,0x07,0x01,0x00,0x01,0x36,0x08,0x01,0x00,0x00,0x3B};
                        //byte mineral [] markingCode = {0x30,0x3B,0x30,0x31,0x30,0x34,0x36,0x33,0x30,0x31,0x32,0x30,0x33,0x35,0x30,0x32,0x34,0x30,0x32,0x31,0x35,0x70,0x2B,0x36,0x6D,0x2C,0x4A,0x33,0x63,0x6C,0x57,0x70,0x6C,0x3C,0x30,0x78,0x31,0x44,0x3E,0x39,0x33,0x71,0x2B,0x4E,0x33,0x3B,(byte) 0xD3,0x07,0x01,0x00,0x01,0x36,0x08,0x01,0x00,0x00,0x3B};
                        ...
                        //byte[] markingCode = {0x30,0x31,0x30,0x32,0x39,0x30,0x30,0x30,0x30,0x30,0x31,0x39,0x33,0x36,0x37,0x33,0x32,0x31,0x5A,0x74,0x64,0x54,0x46,0x46,0x57,0x2F,0x78,0x52,0x4E,0x4E,0x62,0x1D,0x39,0x31,0x46,0x46,0x44,0x30,0x1D,0x39,0x32,0x64,0x47,0x56,0x7A,0x64,0x43,0x4C,0x72,0x59,0x63,0x4B,0x62,0x55,0x62,0x54,0x4B,0x30,0x78,0x77,0x2F,0x47,0x4C,0x36,0x58,0x62,0x79,0x69,0x6F,0x38,0x2F,0x39,0x68,0x72,0x52,0x48,0x6D,0x63,0x33,0x42,0x73,0x75,0x71,0x45,0x3D};
                        ...
                        fptr.directIO(1011, new int[]{7, 0, 0}, "64");
                        fptr.directIO(1011, new int[]{8, 1, 0}, "+7(495)1234567");
                        fptr.directIO(1011, new int[]{16, 1, 0}, "ООО Поставщик");
                        fptr.directIO(1011, new int[]{11, 1, 0}, "г.Москва, ул.Азовская, д.15А");
                        fptr.directIO(1011, new int[]{12, 1, 0}, "7724389850");
                        fptr.directIO(1011, new int[]{5, 2}, "1.11");
                        fptr.directIO(1011, new int[]{13, 1, 0}, "QIWI");
                        fptr.directIO(1011, new int[]{9, 1, 0}, "Перевод денежных средств");
                        fptr.directIO(1011, new int[]{17, 1, 0}, "7707329152");
                        fptr.directIO(1011, new int[]{10, 1, 0}, "+7(495)9262555");
                        fptr.directIO(1011, new int[]{14, 1, 0}, "+7(495)8888888");
                        fptr.directIO(1011, new int[]{15, 1, 0}, "+7(495)5555555");
                        fptr.directIO(1010, new int[]{18, 1}, "1085"); // 1085
                        fptr.directIO(1010, new int[]{19, 1}, "1086"); // 1086
                        fptr.printRecItem("goodexice", 3990, 1000, 1, 3990, "10");
                        //fptr.printRecItem("good1", 4000, 1000, 1, 4000, "00");


                        fptr.directIO(1011, new int[]{2, 1}, "0");
                        //fptr.directIO(1011, new int[]{attrNumber, attrType}, attrValue);
                        fptr.directIO(1011, new int[]{7, 0, 1}, "64");
                        fptr.directIO(1011, new int[]{8, 1, 1}, "+7(495)1234567");
                        fptr.directIO(1011, new int[]{16, 1, 1}, "ООО Поставщик");
                        fptr.directIO(1011, new int[]{11, 1, 1}, "г.Москва, ул.Азовская, д.15А");
                        fptr.directIO(1011, new int[]{12, 1, 1}, "7724389850");
                        //fptr.directIO(1011, new int[]{5, 2}, "1.11");
                        fptr.directIO(1011, new int[]{13, 1, 1}, "QIWI");
                        fptr.directIO(1011, new int[]{9, 1, 1}, "Перевод денежных средств");
                        fptr.directIO(1011, new int[]{17, 1, 1}, "7707329152");
                        fptr.directIO(1011, new int[]{10, 1, 1}, "+7(495)9262555");
                        fptr.directIO(1011, new int[]{14, 1, 1}, "+7(495)8888888");
                        fptr.directIO(1011, new int[]{15, 1, 1}, "+7(495)5555555");

                        fptr.printRecItem("good1good1good1good1good1good1good1good1good1good1good1good1", 3990, 1000, 1, 3990, "10");
...
//                        fptr.directIO(1075, new int[]{0, id}, value);
                        ...
                        fptr.printRecSubtotalAdjustment(FiscalPrinterConst.FPTR_AT_AMOUNT_DISCOUNT, "", 80);
                        // Оплата
                        ...
                        for (int j = 0; j < 8; ++j) {
                            fptr.directIO(1041, new int[]{strAlignment, doubleWidth, doubleHeight, font, modeCachingStr}, String.format(text, j+1));
                        }
                        ...
                        fptr.directIO(1041, new int[]{0, 0, 0, 0, 1}, "6-fc85-44e9-b911-8bec38edf8ff&dt=2");
                        fptr.directIO(1041, new int[]{0, 0, 0, 0, 2}, "003141459&cn=010000006284A3C2DDBDC");
                        fptr.directIO(1041, new int[]{0, 0, 0, 0, 3}, "A0CCFF59104181AABEEA564B01879D7B13");
...
//                    fptr.directIO(1025, null, userProperty);
//                    String[] userProperty = new String[]{"ID15", "ПРИНЯТО:             20000.00"};
//                    fptr.directIO(1025, null, userProperty1);
